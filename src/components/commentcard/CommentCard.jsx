...
export default function CommentCard({dark, message}) {
  return (
    <div className="w-full flex items-center justify-center">
      ...
      <div className={`w-[360px] ${dark?"border border-gray-800":"bg-gray-100"} rounded-2xl p-5 shadow-[0_5px_40px_rgba(0,0,0,0.25)]`}>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <p className={`font-semibold ${dark?"text-gray-200":"text-gray-800"} text-sm`}>
                Instagram
              </p>
        ...
        <p className={`${dark?"text-gray-200":"text-gray-700"} text-sm leading-relaxed mb-4 p-2`}>
          {message}
        </p>
