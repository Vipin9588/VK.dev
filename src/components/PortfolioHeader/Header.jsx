  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      for (const id of [...sections].reverse()) {
        ...
        console.log(
          `el +" &&"+ ${window.scrollY} +" "+ ">=" +${el.offsetTop - 100}`,
        );
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="md:hidden fixed inset-0 z-40 h-[100vh] transition-all duration-300"
          style={{
        ...
        <div
          ref={mobileMenuRef}
          className="md:hidden fixed right-0 top-0 bottom-0 z-50 w-72  h-[100vh] flex flex-col transition-transform duration-300 ease-in-out"
          style={{
              ...
              return (
                <a
                  ...
                  style={{
                    ...
                    color: isActive ? "#2563EB" : dark ? "#cbd5e1" : "#475569",
