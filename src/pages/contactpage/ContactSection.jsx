...
import {
  ...
  FiTwitter, FiDribbble, FiCheckCircle, FiClock, FiUser, FiMessageSquare,
} from "react-icons/fi";

const socialLinks = [
  { icon: FiLinkedin, label: "LinkedIn", href: "#", color: "hover:text-blue-400" },
  { icon: FiGithub,   label: "GitHub",   href: "#", color: "hover:text-gray-300" },
  { icon: FiTwitter,  label: "Twitter",  href: "#", color: "hover:text-sky-400"  },
  { icon: FiDribbble, label: "Dribbble", href: "#", color: "hover:text-pink-400" },
];

const contactInfo = [
  { icon: FiMail,   label: "Email",    value: "vipinkumarak.@gmail.com",  href: "mailto:hello@alexmorgan.dev" },
  { icon: FiPhone,  label: "Phone",    value: "(+91) 9588738897",   href: "tel:+919588738897"            },
  { icon: FiMapPin, label: "Location", value: "Ambala city ,Haryana",     href: "#"                           },
];
    ...
    <section className={` min-h-screen w-screen ${bg} ${text} font-sans py-20 px-4 relative overflow-hidden`}>
      ...
      <div className="relative max-w-6xl mx-auto " >
        ...
        <div className="text-center mb-16">
          ...
          <p className={`${textMuted} text-base max-w-xl mx-auto leading-relaxed`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className={`rounded-2xl border ${cardBorder} ${cardBg} p-6 backdrop-blur-sm`}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className={`${textMuted} text-xs mt-0.5`}>Full-Stack Designer &amp; Developer</p>
                </div>
              </div>
            ...
            <div className={`rounded-2xl border ${cardBorder} ${dark ? "bg-gradient-to-br from-blue-900/20 to-indigo-900/20" : "bg-blue-50"} p-5 backdrop-blur-sm flex items-center gap-4`}>
              ...
              <div>
                ...
                <p className={`${textMuted} text-xs mt-0.5`}>Usually reply within a few hours</p>
              </div>
            </div>
          </div>
            ...
            <div className={`rounded-2xl border ${cardBorder} ${cardBg} p-7 md:p-8 backdrop-blur-sm h-full`}>
              {submitted ? (
                <div className="h-full flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <h3 className={`text-xl font-bold ${text} mb-2`}>Message Sent!</h3>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 h-full">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        <FiUser size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none" />
                        <input
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <FiMail size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-600 pointer-events-none" />
                        <input
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <textarea
                      ...
                      placeholder="Tell me about your project, timeline, budget..." required
                      rows={6}
