    ...
    <section className="font-Primary w-full min-h-scree px-6 lg:px-16 py-20 flex items-center">
      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center lg:items-start gap-6">
          ...
          <div className={`${dark?"text-white":"bg-white  text-gray-600"} p-4 rounded-xl shadow-md max-w-sm`}>
            <p className=" text-sm">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h2 className={`text-4xl font-Secondary  ${dark?"text-white":"text-gray-900"}`}>
            About Me
          </h2>
          ...
          <div className="grid grid-cols-3 gap-6 mt-4">
            ...
            <div className={`${dark?"border border-gray-800":"bg-white"} p-4 rounded-xl shadow text-center`}>
              <h3 className={`text-2xl font-bold ${dark?"text-gray-300":"text-gray-900"}`}>5+</h3>
            ...
            <div className={`${dark?"border  border-gray-800":"bg-white"} p-4 rounded-xl shadow text-center`}>
              <h3 className={`text-2xl font-bold ${dark?"text-gray-300":"text-gray-900"}`}>1</h3>
          ...
          <div className="mt-6">
            <CommentCard dark={dark} message="I'm BCA graduate and full-stack developer who crafts seamless digital experiences." />
          </div>
